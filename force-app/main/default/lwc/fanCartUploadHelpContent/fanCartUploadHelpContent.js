...
import getContent from '@salesforce/apex/fan_B2BCartUploadHelp.getContent';

import USER_LOCALE from '@salesforce/i18n/locale';
import COMMUNITYID from '@salesforce/community/Id';
import BASE_PATH from '@salesforce/community/basePath';

import { retrieveContentLabel } from 'c/fanLabels';

export default class FanCartUploadHelpContent extends LightningElement {
    ...
    get retrieveContentLabel() {
        return retrieveContentLabel();
    };
